/**
 * Resume CSS as a JS string constant — 知网 GB/T 7713 论文规范基线。
 *
 * 这是不可变的基线格式：字体系统、字号层级、行高、三线表、缩进等。
 * 所有视觉装饰（颜色主题、阴影、圆角、装饰线等）通过 extraStyles（themeStyles + customStyles）注入。
 *
 * Usage:
...
/* ============================================
   4. 一级标题 — ## 模块名 15px 加粗，段前 24px 段后 12px
   ============================================ */
.section-title {
  font-family: 'SimHei', '黑体', 'Microsoft YaHei', sans-serif !important;
  font-size: 15px;
...
/* ============================================
   5. 二级标题 — ### 项目名 | 日期 14px 加粗
   段前 18px 段后 8px，右侧日期 12px 灰色右对齐
   ============================================ */
.subsection-title {
  font-family: 'SimHei', '黑体', 'Microsoft YaHei', sans-serif !important;
  font-size: 14px;
...
/* ============================================
   6. 三级标题 — #### 子标题 13px 加粗，段前 12px 段后 6px
   ============================================ */
.resume-document h4 {
  font-family: 'SimHei', '黑体', 'Microsoft YaHei', sans-serif !important;
  font-size: 13px;
...
/* ============================================
   7. 正文 — 宋体 14px 行高 1.5，list-style disc 缩进 1.5em
   ============================================ */
.resume-document p,
.resume-document li {
  font-family: 'SimSun', '宋体', 'Times New Roman', serif;
